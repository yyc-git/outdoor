import { WebGLRenderer, Object3D, Camera, Vector2, Raycaster, Scene, Clock, AnimationMixer, AnimationClip, Mesh, Color, Vector3, LOD, Box3, Group, Matrix4 } from "three"
...
import { InstancedLOD } from "../lod/InstancedLOD2"
...
export type pickTarget = [number, Matrix4, Box3, string]
...
export type collision = {
    playerCollisionOctrees: Array<Octree>,
    cameraCollisionOctrees: Array<Octree>,
}
