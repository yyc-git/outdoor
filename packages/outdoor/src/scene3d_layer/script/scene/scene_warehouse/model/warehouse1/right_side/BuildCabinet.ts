...
import { buildDrawerInstanceId, buildCabinetBodyName, buildDrawerName, getDrawer, getType } from "../../../manage/warehouse1/Cabinet1";
...
export let build = (state: state, cabinetNumber: number) => {
    ...
    cabinet.name = buildCabinetName(cabinetNumber, getType())
